...
internal sealed class ConcurrentBitmapClusterNode : ConcurrentBitmapNode
{
    ...
    // this class is very hot, as it's used by job scheduling
    ...
    public ConcurrentBitmapClusterNode(int externalNodeIndex, int baseAddress, int clusterBitSize, IParentNode parent) : base(externalNodeIndex, baseAddress, parent, clusterBitSize)
    {
        ...
        _segmentLocks = new Lock[_segmentCount];
    ...
    internal override bool Shrink(int removalSize)
    {
        ...
        else
        {
            ...
            int removedSegmentCount = Math.FastMax((lastSegmentRemovalSize + SEGMENT_BIT_SIZE - 1) / SEGMENT_BIT_SIZE, 1);
    ...
    internal override bool Grow(int additionalSize)
    {
        ...
        else
        {
            ...
            {
                Lock[] oldSegmentLocks = _segmentLocks;
                _segmentLocks = new Lock[newTotalSegmentCount];
