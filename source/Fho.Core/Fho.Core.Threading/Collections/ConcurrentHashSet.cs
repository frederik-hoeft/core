...
/// </remarks>
// based on the .NET 6 implementation of ConcurrentDictionary
...
public class ConcurrentHashSet<T> : IReadOnlyCollection<T>, ICollection<T>
{
    ...
    public void Clear()
    {
        ...
        try
        {
            ...
            Tables newTables = new(new Node[DEFAULT_CAPACITY], tables.Locks, new int[tables.CountPerLock.Length]);
            _tables = newTables;
